...
get_ipython().system(u'pip install pyexr')
get_ipython().system(u'pip install torch')
get_ipython().system(u'pip install torchvision')
get_ipython().system(u'pip install scikit-image')
...
get_ipython().system(u'wget -O sample.exr https://www.dropbox.com/s/nhunb2e9i0dr8sz/10064185-00256spp.exr?dl=1 # note dl=1 instead of dl=0!')
get_ipython().system(u'wget -O sample2.exr https://www.dropbox.com/s/xjf395828x05lxr/10430937-00256spp.exr?dl=1')
get_ipython().system(u'wget -O sample3.exr https://www.dropbox.com/s/dzi8m1xpdutszeq/10095699-00256spp.exr?dl=1')
get_ipython().system(u'wget -O sample4.exr https://www.dropbox.com/s/wgkjmxaf3m2ldkf/10447261-00256spp.exr?dl=1')
get_ipython().system(u'wget -O sample5.exr https://www.dropbox.com/s/45tbqti8q5g55oa/10499343-00256spp.exr?dl=1')
get_ipython().system(u'wget -O sample6.exr https://www.dropbox.com/s/b0rwu7hcwkkmmm1/12421083-00256spp.exr?dl=1')
get_ipython().system(u'wget -O sample7.exr https://www.dropbox.com/s/7b06a2i4pvo95ec/10481186-00256spp.exr?dl=1')
...
get_ipython().system(u'wget -O gt4.exr https://www.dropbox.com/s/0cx5tjmmng28von/10447261-08192spp.exr?dl=1')
get_ipython().system(u'wget -O gt5.exr https://www.dropbox.com/s/bgq9v0967g8h7nl/10499343-08192spp.exr?dl=1')
get_ipython().system(u'wget -O gt6.exr https://www.dropbox.com/s/pr9z8t0g8vyotlj/12421083-08192spp.exr?dl=1')
get_ipython().system(u'wget -O gt7.exr https://www.dropbox.com/s/vtjx46jmo5nhrvf/10481186-08192spp.exr?dl=1')
get_ipython().system(u'wget -O gt8.exr https://www.dropbox.com/s/fkf63fq4azw0g9z/10848082-08192spp.exr?dl=1')
get_ipython().system(u'wget -O gt9.exr https://www.dropbox.com/s/5jq4q0m4sv3bw52/11109097-08192spp.exr?dl=1')
...
kdiffuseNet, kspecularNet, klDiff, klSpec, klFinal = train(mode='KPCN', epochs=140, learning_rate=1e-5)
...
show_data(eval_data['finalGt']**0.45454545)

eval_data = crop(eval_data, (1280//2, 720//2), 300)
show_data(np.clip(data['finalGt'], 0, 1))
show_data(eval_data['finalGt']**0.45454545)
...
data = preprocess_input("eval1.exr", "evalref1.exr", debug=True)
show_data(np.clip(data['finalGt'], 0, 1)**0.3)
...
get_ipython().system(u'wget -O eval4.exr https://www.dropbox.com/s/jib5tda6bey30ce/25922544-00256spp.exr?dl=1')
  
get_ipython().system(u'wget -O evalref4.exr https://www.dropbox.com/s/ud0i5pf4f4zbbjj/25922544-08192spp.exr?dl=1')
