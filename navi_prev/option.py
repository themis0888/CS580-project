...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/siit/navi/data/input_data/deep_learning_denoising/renderings/',
...
parser.add_argument('--recon_kernel_size', type=int, default=5,
                    help='number of kernel')
